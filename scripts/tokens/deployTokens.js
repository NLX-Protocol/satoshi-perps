...
async function main() {
  ...
  addresses["SOLV"] = (await callWithRetries(deployContract, ["SyntheticToken", ["SOLV/USD", "SOLV"]])).address
  addresses["TRUMP"] = (await callWithRetries(deployContract, ["SyntheticToken", ["TRUMP/USD", "TRUMP"]])).address
  addresses["BERA"] = (await callWithRetries(deployContract, ["SyntheticToken", ["BERA/USD", "BERA"]])).address
  addresses["VIRTUAL"] = (await callWithRetries(deployContract, ["SyntheticToken", ["VIRTUAL/USD", "VIRTUAL"]])).address
  addresses["APT"] = (await callWithRetries(deployContract, ["SyntheticToken", ["APT/USD", "APT"]])).address
