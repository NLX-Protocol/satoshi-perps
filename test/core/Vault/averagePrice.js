...
describe("Vault.averagePrice", function () {
  ...
  it("position.averagePrice, buyPrice != markPrice", async () => {
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("99702400000000000000") // 99.7024
    expect(await slpManager.getAumInUsdg(true)).eq("100192710000000000000") // 100.19271
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("102202981000000000000") // 102.202981
    expect(await slpManager.getAumInUsdg(true)).eq("103183601000000000000") // 103.183601
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("102203938000000000000") // 102.203938
    expect(await slpManager.getAumInUsdg(true)).eq("102740698000000000000") // 102.740698
  ...
  it("position.averagePrice, buyPrice == markPrice", async () => {
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("99700000000000000000") // 99.7
    expect(await slpManager.getAumInUsdg(true)).eq("102192500000000000000") // 102.1925
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("102202981000000000000") // 102.202981
    expect(await slpManager.getAumInUsdg(true)).eq("102202981000000000000") // 102.202981
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("102203487000000000000") // 102.203487
    expect(await slpManager.getAumInUsdg(true)).eq("102203487000000000000") // 102.203487
  ...
  it("short position.averagePrice, buyPrice > averagePrice", async () => {
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("100697000000000000000") // 100.697
    expect(await slpManager.getAumInUsdg(true)).eq("100697000000000000000") // 100.697
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("123197000000000000000") // 123.197
    expect(await slpManager.getAumInUsdg(true)).eq("123197000000000000000") // 123.197
  ...
  it("short position.averagePrice, buyPrice < averagePrice", async () => {
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("78197000000000000000") // 78.197
    expect(await slpManager.getAumInUsdg(true)).eq("78197000000000000000") // 78.197
  ...
  it("short position.averagePrice, buyPrice < averagePrice - minProfitBasisPoints", async () => {
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("100022000000000000000") // 100.022
    expect(await slpManager.getAumInUsdg(true)).eq("100022000000000000000") // 100.022
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("98270677581863979848") // 98.270677581863979848
    expect(await slpManager.getAumInUsdg(true)).eq("98270677581863979848") // 98.270677581863979848
