...
describe("Vault.depositCollateral", function () {
  ...
  it("deposit collateral", async () => {
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("93718200000000000000") // 93.7182
    expect(await slpManager.getAumInUsdg(true)).eq("95334980000000000000") // 95.33498
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("109886000000000000000") // 109.886
    expect(await slpManager.getAumInUsdg(true)).eq("111502780000000000000") // 111.50278
    ...
    expect(await slpManager.getAumInUsdg(false)).eq("109886000000000000000") // 109.886
    expect(await slpManager.getAumInUsdg(true)).eq("111503780000000000000") // 111.50378
